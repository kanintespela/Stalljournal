...
Felregistrerade journalrader (förflyttningar, vägningar, hullbedömningar, behandlingar) kan tas bort direkt från djurkortet — folk gör fel ibland, och en journal man inte kan rätta blir fel för alltid. Borttagning är en soft delete (raden döljs och synkas som borttagen, försvinner på alla enheter). Obs: att ta bort en flytt som hann ändra djurets status återställer **inte** statusen automatiskt — det sägs i bekräftelsedialogen, och statusen ändras i så fall via Redigera på djurkortet.
