...
**Vad appen inte gör:** ett förflyttningsdokument (fysiskt dokument som ska följa djuren till mottagande anläggning) och den lagstadgade anmälan till Jordbruksverkets förflyttningsregister (inom 7 dagar) är separata krav utöver själva journalföringen (48 timmar). Appen varken genererar det förstnämnda eller integrerar mot myndighetens e-tjänst för det sistnämnda ännu.
