...
- [x] **Fas 6b — Avelsegenskaper:** egna, fritt definierade egenskaper (temperament, exteriör, ullfällning m.m.) med registrering per djur och rangordning per egenskap; tillväxtjämförelse korrigerad för kullstorlek (kontemporärgruppsjämförelse). Se `docs/avel.md` för bakgrund, metod och varför BLUP inte byggs lokalt.
